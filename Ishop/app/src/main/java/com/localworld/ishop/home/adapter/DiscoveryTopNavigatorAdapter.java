...
public class DiscoveryTopNavigatorAdapter extends CommonNavigatorAdapter {

    private List<HomeCategoryBean> categoryList = new ArrayList<>();
    private DiscoveryCategoryClickListener categoryClickListener;
    ...
    public void setDisCategoryClickListener(DiscoveryCategoryClickListener listener) {
     ...
     * 分类点击监听
     */
    public interface DiscoveryCategoryClickListener {

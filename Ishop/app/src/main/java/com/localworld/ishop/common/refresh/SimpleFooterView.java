...
public class SimpleFooterView extends BaseFooterView{
    ...
    private YJRefreshView YJRefreshView;
    ...
    public SimpleFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        view = LayoutInflater.from(getContext()).inflate(R.layout.view_footer_refresh, this);
    ...
    public void setYJRefreshView(YJRefreshView YJRefreshView) {
        this.YJRefreshView = YJRefreshView;
    }
    ...
    public void onError() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onLoadingMore();
                YJRefreshView.mListener.onLoadMore();
            }
        });
    }

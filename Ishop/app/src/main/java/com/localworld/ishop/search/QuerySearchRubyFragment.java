...
import com.localworld.ishop.search.adapter.SearchRubyRecycleAdapter;

public class QuerySearchRubyFragment extends Fragment {
    ...
    private void initView() {
        ...
        SearchRubyRecycleAdapter adapter = new SearchRubyRecycleAdapter(getActivity());
        recyclerView.setLayoutManager(new  LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(adapter);
        adapter.setClickListener(new SearchRubyRecycleAdapter.ItemClickListener(){
            @Override

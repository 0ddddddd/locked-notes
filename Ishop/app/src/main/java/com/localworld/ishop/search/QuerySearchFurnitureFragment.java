...
import com.localworld.ishop.search.adapter.SearchFurnitureRecycleAdapter;

public class QuerySearchFurnitureFragment extends Fragment {
    ...
    private void initView() {
        recyclerView= (RecyclerView) view.findViewById(R.id.rv_search_types);
        SearchFurnitureRecycleAdapter adapter = new SearchFurnitureRecycleAdapter(getActivity());
        recyclerView.setLayoutManager(new  LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(adapter);
        adapter.setClickListener(new SearchFurnitureRecycleAdapter.ItemClickListener(){
            @Override

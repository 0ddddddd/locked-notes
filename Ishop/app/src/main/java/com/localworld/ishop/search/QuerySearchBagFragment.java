...
import com.localworld.ishop.search.adapter.SearchBagRecycleAdapter;

public class QuerySearchBagFragment extends Fragment {
    ...
    private void initView() {
        ...
        SearchBagRecycleAdapter adapter = new SearchBagRecycleAdapter(getActivity());
        recyclerView.setLayoutManager(new  LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(adapter);
        adapter.setClickListener(new SearchBagRecycleAdapter.ItemClickListener(){
            @Override

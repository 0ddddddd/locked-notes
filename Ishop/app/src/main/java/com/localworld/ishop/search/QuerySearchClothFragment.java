...
import com.localworld.ishop.search.adapter.SearchClothRecycleAdapter;

public class QuerySearchClothFragment extends Fragment {
    ...
    private void initView() {
        ...
        SearchClothRecycleAdapter adapter = new SearchClothRecycleAdapter(getActivity());
        recyclerView.setLayoutManager(new  LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(adapter);
            adapter.setClickListener(new SearchClothRecycleAdapter.ItemClickListener(){
            @Override

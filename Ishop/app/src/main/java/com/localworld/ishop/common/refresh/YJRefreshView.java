package com.localworld.ishop.common.refresh;
 ...
 */
public class YJRefreshView extends FrameLayout
    ...
    public YJRefreshView(Context context) {
        this(context, null);
    }

    public YJRefreshView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YJRefreshView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void setupSwipeRecyclerView() {
        ...
        mFootView.setYJRefreshView(this);
    ...
    public void setEmptyView(String s) {
        ...
        if (mEmptyView == null) {
            mEmptyView = LayoutInflater.from(context).inflate(R.layout.view_empty_refresh, null);
    ...
    public void setErrorView() {
        ...
        if (mErrorView == null) {
            mErrorView = LayoutInflater.from(context).inflate(R.layout.view_error_refresh, null);
